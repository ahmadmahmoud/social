...
<div class="app-content-inner" id="postpage">
    <div class="content-section">
        ...
        <div class="text-center" style="margin:20px 0">
            <button csrf_token="<?php echo $csrf['hash'];?>" type="button" class="btn btn-success" id="loadmore" more="1" post_id="<?php echo $post_id;?>"><?php echo $this->lang->line('label_loadmore');?></button>
        </div>
        <?php }?>
    </div>
