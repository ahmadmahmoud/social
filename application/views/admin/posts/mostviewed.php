...
<div class="content-heading" dir="<?php echo $direction;?>">
    <div class="app-content-inner">
        <ol class="content-breadcrumb breadcrumb breadcrumb-arrow">
            ...
            <li><a href="<?php echo $this->config->item('admin_url'); ?>posts"><?php echo $this->lang->line('section_posts');?></a></li>
            <li class="active"><?php echo $this->lang->line('section_posts_mostviewed');?></li>
        </ol>
    </div>
</div>

<div class="app-content-inner" id="postpage">
        ...
        <div class="row">
            <div id="columns" data-columns> 
                ...
                foreach ($posts as $postinfo) {
                    ...
                    if ($type === 'video') {
                        $html .= '<div>';
                        $html .= '<video id="video" class="rounded-top" poster="' . $postinfo->thumb . '" controls crossorigin style="width:100%">';
