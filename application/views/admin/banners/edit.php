...
<div class="content-heading" dir="<?php echo $direction;?>">
    ...
    <div class="app-content-inner">
        ...
        <ol class="content-breadcrumb breadcrumb breadcrumb-arrow">
            ...
            <li class="active"><?php echo $this->lang->line('label_edit');?></li>
        </ol>
        <!-- /.content-breadcrumb -->
    </div>
    <!-- /.app-content-inner -->
...
<div class="app-content-inner" dir="<?php echo $direction;?>">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-7">
            <div class="panel">
                <form action="<?php echo $this->config->item('admin_url'); ?>banners/update" class="form-compound" id="formeditbanner" name="formeditbanner" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-12">
                                ...
                                <input type="text" class="form-control" id="url_android" required="" name="url_android" value="<?php echo $banner->url_android;?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-12">
                                ...
                                <input type="text" class="form-control" id="url_ios" required="" name="url_ios" value="<?php echo $banner->url_ios;?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-12">
                                <a data-fancybox="group" href="<?php echo base_url() . BANNER_URL . $banner->image; ?>">
                                    <img style="width: 70%" src="<?php echo base_url() . BANNER_URL . $banner->image; ?>">
                                </a>
                            </div>
                        </div>
