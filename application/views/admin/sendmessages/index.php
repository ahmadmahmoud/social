...
<div class="content-heading" dir="<?php echo $direction;?>">
    <div class="app-content-inner">
        <ol class="content-breadcrumb breadcrumb breadcrumb-arrow">
            ...
            <li class="active"><?php echo $this->lang->line('section_sendmessages');?></li>
        </ol>
    </div>
</div>
<div class="app-content-inner">
    <h3 class="page-header" dir="<?php echo $direction;?>"><?php echo $this->lang->line('section_sendmessages');?></h3>
                    ...
                    <div class="content-toolbar">
                        ...
                        <form class="form-inline">
                            ...
                            <div class="form-group">
                                <button type="button" class="btn btn-compact btn-block btn-success" id="btn-sendmessage">
...
<div id="modalSendMessages" class="modal fade" tabindex="-1" role="dialog">
    <!-- .modal-dialog -->
    <div class="modal-dialog" role="document">
        <!-- .modal-content -->
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h4 class="modal-title"><?php echo $this->lang->line('section_sendmessages');?></h4>
            </div>
            <div class="modal-body">
                <form action="<?php echo $this->config->item('admin_url'); ?>sendmessages/add" class="form-compound" id="formsendmessage" name="formsendmessage" method="POST">
                    <div class="form-section">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-success" id="sendmessage"><?php echo $this->lang->line('label_send');?></button>
                        </div>
                    </div>
