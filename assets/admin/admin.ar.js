    ...
    return {
            ...
            $('#table').on('click', '.approverequest', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response) {
                            if (response.success) {
                                swal('Success', "تم الموافقة على الطلب", 'success');
                                table.row(obj.parents('tr')).remove().draw();
                            } else {
                                swal('خطأ', response.msg, 'error');
                            }
                        } else {
                            swal('خطأ', "طلب غير صحيح", 'error');
                        }
                    },
                    error: function (jqXHR, textStatus) {
                        swal('خطأ', "طلب غير صحيح", 'error');
            ...
            $('#table').on('click', '.rejectrequest', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response) {
                            if (response.success) {
                                swal('Success', 'تم رفض الطلب', 'success');
                                table.row(obj.parents('tr')).remove().draw();
                            } else {
                                swal('خطأ', response.msg, 'error');
                            }
                ...
                swal({
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response) {
                                if (response.success) {
                                    swal('تم الحذف', response.msg, 'success');
                                    table.row(obj.parents('tr')).remove().draw();
                                } else {
                                    swal('خطأ', response.msg, 'error');
                                }
        ...
        UpdateBanner: function () {
            $('#formeditbanner').validate({
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response) {
                                ...
                                swal('خطأ', 'Invalid Request', 'error');
                            }
                        },
                        error: function (jqXHR, textStatus) {
                        },
                ...
                messages: {
                    url_android: {
                        required: 'الرجاء إدخال android رابط'
                    },
                    url_ios: {
                        required: 'الرجاء إدخال ios رابط'
                    }
                },
                errorElement: 'em',
                ...
                $('#saveagreement').on('click', function () {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response) {
                                if (response.success) {
                                    swal('محدث', response.msg, 'success');
                                } else {
                                    swal('خطأ', response.msg, 'error');
                                }
                            } else {
        ...
        UpdatePassword: function () {
            $('#formadminpwd').validate({
                submitHandler: function () {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response) {
                                if (response.success) {
                                    swal('نجاح', response.msg, 'success');
                                } else {
                                    swal('خطأ', response.msg, 'error');
                                }
                            } else {
                ...
                messages: {
                    curpwd: {
                        required: 'يرجى تقديم كلمة المرور الحالية',
                        minlength: 'يجب أن تتكون كلمة المرور الحالية من خمسة أحرف على الأقل'
                    },
                    newpwd: {
                        required: 'يرجى تقديم كلمة مرور جديدة',
                        minlength: 'يجب أن تتكون كلمة المرور الجديدة من خمسة أحرف على الأقل'
                    },
                    retpwd: {
                        required: 'يرجى التأكد من صحة كلمة المرور الخاصة بك',
                        minlength: 'تأكيد كلمة المرور لا تتطابق مع كلمة المرور الجديدة'
                    }
                },
                errorElement: 'em',
                errorPlacement: function (error, element) {
        ...
        UpdateSettings: function () {
            $('#formsettings').validate({
                ...
                messages: {
                    app_name: {
                        required: 'يرجى إدخال اسم التطبيق'
                    }
                },
                errorElement: 'em',
                errorPlacement: function (error, element) {
            ...
            $('#formlogin').validate({
                ...
                messages: {
                    username: {
                        ...
                        minlength: 'يجب أن يتكون اسم المستخدم من حرفين على الأقل'
                    },
                    password: {
                        required: 'يرجى إدخال كلمة المرور',
                        minlength: 'يجب أن تتكون كلمة المرور من خمسة أحرف على الأقل'
                    }
                },
                errorElement: 'em',
                errorPlacement: function (error, element) {
